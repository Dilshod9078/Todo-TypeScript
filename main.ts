...
const saveLocalStorage = (key:string, todos:any):void => {
...
let elForm:Element | null = document.querySelector(".form")
let elList:Element | null = document.querySelector(".form__list")
let elInput:Element | null = document.querySelector(".form__input")
let elmodalWrapper:Element | null = document.querySelector(".wrapper__modal")
let elModal:Element | null = document.querySelector(".modal")

let elAll:Element | null = document.querySelector(".all")
let elCompleted:Element | null = document.querySelector(".Complete")
let elUncompleted:Element | null = document.querySelector(".unComplete")

let elAllcount:Element | null = document.querySelector(".all-count")
let elCompletecount:Element | null = document.querySelector(".complete-count")
let elUncompletecount:Element | null = document.querySelector(".uncomplete-count")

const todoList:TodoTypes[] = getStorage("todo") || []
...
function renderTodo (arr:TodoTypes[]){
    if(elList){
        elList.innerHTML = ""
    }
    arr.map((item, index) => {
...
function updateClick(id:number){
    if(elmodalWrapper && elModal){
        elmodalWrapper.classList.add("open-modal")
...
function updateBtnClick(id:number){
    let elIpnutvalue: HTMLInputElement | null = document.querySelector(".modal-input") as HTMLInputElement | null;
...
if(elmodalWrapper){
    ...
    elmodalWrapper.addEventListener("click", function(evt){
        if ((evt.target as HTMLElement).id === "wrapper__modal") {
            if (elmodalWrapper) {
                elmodalWrapper.classList.remove("open-modal");
            }
        }
